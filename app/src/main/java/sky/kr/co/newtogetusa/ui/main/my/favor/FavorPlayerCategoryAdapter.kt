...
import sky.kr.co.newtogetusa.databinding.ItemFavorPlayerCategoryBinding
import sky.kr.co.newtogetusa.ui.base.BaseViewHolder

class FavorPlayerCategoryAdapter(val viewModel: FavorPlayerViewModel): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    val items = mutableListOf<String>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ViewHolder(ItemFavorPlayerCategoryBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class ViewHolder(val bind:ItemFavorPlayerCategoryBinding): BaseViewHolder(bind.root){
